        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="card-gradient rounded-xl p-8">
              <h2 className="text-sm font-bold uppercase tracking-widest text-[#EEFF00] mb-4">Call Us</h2>
              <a href="tel:7808189904" className="text-2xl font-black text-white hover:text-[#EEFF00] transition-colors">
                780.818.9904
              </a>
            ...
            <div className="card-gradient rounded-xl p-8">
              <h2 className="text-sm font-bold uppercase tracking-widest text-[#EEFF00] mb-4">Location</h2>
            ...
            <div className="card-gradient rounded-xl p-8">
              <h2 className="text-sm font-bold uppercase tracking-widest text-[#EEFF00] mb-4">Follow Us</h2>
