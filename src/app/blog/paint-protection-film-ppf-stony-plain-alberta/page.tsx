...
, it &quot;wants&quot; to return to its original flat state. When
            ...
            <div className="card-gradient rounded-2xl p-6 sm:p-8">
              ...
              <div className="mt-2 grid sm:grid-cols-2 gap-4">
                <div>
                  <div className="text-xs font-bold uppercase tracking-widest text-[#EEFF00] mb-2">Heals ✓</div>
            ...
            {[
              ...
              <div
                ...
                className={`rounded-2xl p-6 sm:p-8 border ${
                  item.highlight
                    ? "border-[#EEFF00]/30 bg-[#EEFF00]/[0.05]"
                    : "card-gradient"
                }`}
              >
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[#EEFF00]/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#EEFF00] font-semibold mb-3">{item.bestFor}</p>
                    ...
                    <p className="text-sm text-[#999] leading-relaxed">
                      <strong className="text-[#EEFF00]">Alberta verdict: </strong>
                      {item.albertaVerdict}
                    </p>
                  </div>
                </div>
