      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <section id="vs-wax-ppf" className="mt-16 scroll-mt-24">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-[#EEFF00]/30 bg-gradient-to-br from-[#EEFF00]/[0.06] to-[#141414]">
              ...
              <div className="p-6 sm:p-8">
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <span className="flex-shrink-0 text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full border text-[#EEFF00] border-[#EEFF00]/30 bg-[#EEFF00]/10">
                    2 - 7 years
                  </span>
                </div>
                <p className="text-sm text-[#999] leading-relaxed">
          ...
          <Callout variant="info">
            ...
            vehicle. Accurate Autoworks offers both services under one roof,             ask about combination pricing when you call{" "}
            <a href="tel:7808189904" className="text-[#EEFF00] hover:underline font-bold">
              780.818.9904
            </a>
            . For comparison, our{" "}
            <Link href="/blog/ppf-vs-vinyl-wrap-alberta-guide/" className="text-[#EEFF00] hover:underline">
